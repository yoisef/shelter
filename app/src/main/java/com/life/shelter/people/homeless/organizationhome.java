...
public class organizationhome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organizationhome);
        ...
        listViewTrampA= (ListView)findViewById(R.id.list_view_tramp_org);
            ...
            if(country != null &&  type != null) {
                databaseTramp.child(country).child(type).child("users").child(userId).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        TrampHomeAdapter adaptera = new TrampHomeAdapter(organizationhome.this, trampList);
